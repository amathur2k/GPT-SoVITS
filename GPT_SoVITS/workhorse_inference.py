...
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language, opfile, how_to_cut=i18n("不切"),
    ...
    sf.write(opfile, audio_data, hps.data.sampling_rate, format='wav')
